...
def write_model(model_path, input_base_path, model_size, safe_serialization=True):
    ...
    max_shard_size = '1000GB' if safe_serialization else '10GB'
    model.save_pretrained(model_path, safe_serialization=safe_serialization, max_shard_size=max_shard_size)
