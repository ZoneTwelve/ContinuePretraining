...
class DataModuleForMultipleChoiceQuestion(LightningDataModuleX):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizerBase, k_shot: int, *, data_path: str | None = None, dataset_path: str | None = None, train_batch_size: int = 1, val_batch_size: int | None = None, test_batch_size: int | None = None, pred_batch_size: int | None = None, train_split_size: int | float | None = None, val_split_size: int | float | None = None, test_split_size: int | float | None = None, pred_split_size: int | float | None = None, split_seed: int | None = 42, num_workers: int = 1, pin_memory: bool = True, num_proc: int | None = None, datacollator_kwargs: Dict[str, Any] | None = None) -> None:
