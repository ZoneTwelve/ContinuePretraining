...
def _load_state_dict_pre_hook(module: "PartiallyFrozenLinear", state_dict: Dict[str, Tensor], prefix: str, local_metadata, strict, missing_keys, unexpected_keys, error_msgs):
    ...
    if 'bias' in state_dict:
        ...
        state_dict[f'{prefix}b1'] = bias[:module.pivot]
        state_dict[f'{prefix}b2'] = bias[module.pivot:]
