...
__all__ = ['get_state_dict_from_zero_checkpoint']
...
def _get_state_dict_from_zero_checkpoint(ds_checkpoint_dir, dtype):
    """
    ...
    for shapes, full_single_fp32_vector in zip(param_shapes, merged_single_partition_of_fp32_groups):
        ...
        for name, shape in shapes.items():
            ...
            state_dict[name] = full_single_fp32_vector.narrow(
                0,
                offset,
                unpartitioned_numel).view(shape).to(dtype)
...
def get_state_dict_from_zero_checkpoint(checkpoint_dir: str, tag: Optional[str] = None, dtype: torch.dtype = torch.float32):
    """
    ...
    return _get_state_dict_from_zero_checkpoint(ds_checkpoint_dir, dtype)
